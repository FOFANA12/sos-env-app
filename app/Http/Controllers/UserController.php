...
class UserController extends Controller
{
    ...
    {
        $this->messageSuccessCreated = __('app/user.controller.message_success_created');
        $this->messageSuccessUpdated = __('app/user.controller.message_success_updated');
    ...
    /**
     * Return required dependencies for user forms.
     */
